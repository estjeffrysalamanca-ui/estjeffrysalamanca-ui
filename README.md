<h1 align="center">Hola 👋, Soy jeffry 


<h3 align="center">Un apasionado de la robotica y la inovacion </h3>



<p align="left">
  <a href="https://x.com/Jeffry_Emanuel_" target="_blank">
    <img src="https://img.shields.io/badge/X-@Jeffry__Emanuel__-000000?style=for-the-badge&logo=x&logoColor=white" alt="X Profile" />
  </a>
</p>
...
- Estudiante de Ingeniería Mecatrónica, apasionado por la robótica, la inteligencia artificial y la innovación tecnológica. Me interesa el desarrollo de sistemas inteligentes y autónomos capaces de resolver problemas reales y generar un impacto positivo en la sociedad.

- Participo activamente en proyectos académicos y actividades de investigación, donde disfruto aprender a través de la experimentación, el diseño y la resolución de desafíos de ingeniería. Considero que cada proyecto representa una oportunidad para adquirir nuevos conocimientos, fortalecer mis habilidades técnicas y seguir creciendo como profesional.

- Mis principales áreas de interés incluyen la robótica, la automatización, la inteligencia artificial y el diseño mecatrónico, integrando mecánica, electrónica y programación para crear soluciones innovadoras.

- En este repositorio comparto parte de mi proceso de aprendizaje, incluyendo proyectos académicos, prácticas, investigaciones y desarrollos personales que reflejan mi evolución como futuro ingeniero mecatrónico.
 </div> <br/>
...
Este apartado reúne la documentación científica y técnica utilizada como referencia durante el desarrollo del proyecto de robot médico. Cada carpeta contiene artículos de investigación especializados en diferentes áreas fundamentales para el diseño, implementación y evaluación del sistema robótico.
...
# 📊 Registro y Organización de Artículos

Con el fin de mantener un seguimiento organizado de la documentación consultada, se ha elaborado un registro donde se clasifican los artículos utilizados, incluyendo información relevante como fechas, categorías, referencias y observaciones asociadas a cada documento. Este registro facilita la trazabilidad de la investigación y permite una gestión más eficiente de las fuentes bibliográficas empleadas durante el desarrollo del proyecto.

<p align="center">
    <a href="https://unimilitareduco-my.sharepoint.com/:x:/g/personal/est_jeffry_salamanca_unimilitar_edu_co/IQCwQALH3aZ-TKnj5Z3LML30ARXWKFRtXaWocno-cAGpLl8?e=tdlakb">
        <img src="https://img.shields.io/badge/📊%20Registro%20de%20Artículos-Excel%20Organizado-217346?style=for-the-badge&logo=microsoft-excel&logoColor=white">
    </a>
</p>
